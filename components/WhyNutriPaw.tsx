...
export default function WhyNutriPaw() {
  return (
    <section id="dlaczego" className="bg-[var(--cream)] px-5 py-14 sm:px-8 sm:py-16 md:px-12 md:py-20">
            ...
            {pillars.map((p) => (
              <div key={p.title} className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: "rgba(29, 61, 47, 0.55)", lineHeight: 1.6 }}>{p.text}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {reviews.map((r) => (
            <div
              ...
              style={{
                background: "#fff",
                border: "1px solid rgba(29, 61, 47, 0.08)",
                borderRadius: 16,
                padding: 24,
                boxShadow: "0 4px 20px rgba(29, 61, 47, 0.06)",
              }}
            >
              ...
              <div style={{ fontSize: 12, color: "rgba(29, 61, 47, 0.4)", fontWeight: 500 }}>{r.author}</div>
            </div>
          ))}
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid rgba(29, 61, 47, 0.12)",
              borderRadius: 16,
              padding: 24,
              display: "flex",
          ...
          >
            ...
            <div style={{ fontSize: 14, color: "rgba(245, 240, 232, 0.55)", marginTop: 4 }}>średnia ocena</div>
            <div style={{ color: "var(--gold)", letterSpacing: 3, marginTop: 6, fontSize: 16 }}>★★★★★</div>
            <div style={{ fontSize: 12, color: "rgba(245, 240, 232, 0.35)", marginTop: 8 }}>na podstawie 312 opinii</div>
          </div>
        </div>
      </div>
    </section>
